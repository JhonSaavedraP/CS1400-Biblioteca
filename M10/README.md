...
3. Puntos Extra: Investiga como importar la libreria datetime para que cada entrada incluya la fecha y hora automatica. O haz que cada linea en el archivo de text comience con un guion.